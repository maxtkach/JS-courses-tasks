...
export class Admin extends User {
  ...
  renderCourses() {
    document.write(`${this.courses.map(course=>`<p class="user__courses--course student">Title: ${course.title} <span class="satisfactory">Admins score:${course.score}</span> <span class="satisfactory">Lector: ${course.lector}
      </span></p>`).join(' ')})`);
  }
}